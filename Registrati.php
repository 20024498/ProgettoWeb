        ...
        <section class="sezioneRegistrati">
            ...
            <div class="formRegistrati">
                ...
                <div class="wrapCredenzialiRegistrati">
                    ...
                    <input class="credenziale Nome" type="text" placeholder=" Nome*" name="nome" required>
                    <input class="credenziale Cognome" type="text" placeholder=" Cognome*" name="cognome" required>
                    <input class="credenziale Email" type="email" placeholder=" Indirizzo Email*" name="mail" required>
